...
export const AplusRiskManagement: React.FC = () => {
  ...
  const containerStyle: React.CSSProperties = {
    ...
    marginRight: showGovernanceSidebar ? '400px' : '0'
  };
  ...
  const handleEntityRiskHistory = (entityId: string, riskId: string) => {
    console.log('Opening history for:', entityId, riskId);
    // This would open a history panel or navigate to a detail view
  };
        ...
        <div style={headerStyle}>
          <div style={topRowStyle}>
            ...
            <button
              ...
              onClick={() => setShowGovernanceSidebar(true)}
              onMouseEnter={(e) => {
